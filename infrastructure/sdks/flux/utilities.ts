...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("flux");
			params.setVersion("1.6.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ZsdXhjZC9mbHV4IiwidmVyc2lvbiI6IjEuNi40In19"), c => c.charCodeAt(0)));
