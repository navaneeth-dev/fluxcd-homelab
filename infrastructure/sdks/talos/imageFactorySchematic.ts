...
export class ImageFactorySchematic extends pulumi.CustomResource {
    ...
    /**
     * The schematic yaml respresentation to generate the image. If not set, a vanilla Talos image schematic will be generated.
     * > Refer to [image-factory](https://github.com/siderolabs/image-factory?tab=readme-ov-file#post-schematics) for the
     * schema.
     */
    ...
    constructor(name: string, argsOrState?: ImageFactorySchematicArgs | ImageFactorySchematicState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ImageFactorySchematic.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
